import os 
import litellm
from config import TOGETHER_MODEL_NAMES, LITELLM_TEMPLATES, API_KEY_NAMES, Model, AZURE_ENDPOINT, AZURE_API_VERSION, AZURE_DEPLOYMENT
...
class APILiteLLM(LanguageModel):
    ...
    def get_litellm_model_name(self, model_name):
        ...
        elif model_name == Model.gpt_4:
            litellm_name = f"azure/{AZURE_DEPLOYMENT}"
    ...
    def batched_generate(self, convs_list: list[list[dict]], 
        ...
        if self.model_name == Model.gpt_4:
